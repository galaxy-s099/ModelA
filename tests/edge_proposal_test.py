...
from models.edge_encoder import fc_to_signed_edge_vector
...
def main():
    ...
    assert fc_to_signed_edge_vector(batch["aal"]).shape == (4, 8 * 7)
    ...
    print("Edge proposal test passed.")
