...
class SMAFProposalNet(nn.Module):
    """
    Strict implementation of the proposed Signed Multi-Atlas framework:

    1. Two-state signed graph propagation for each atlas.
    2. Cross-atlas feature enhancement at graph-embedding level.
    3. Per-atlas classifiers and energy-aware decision-level fusion.
    """
    ...
    def forward(self, batch):
        ...
        fusion_logits = torch.sum(atlas_weight.unsqueeze(-1) * stacked_logits, dim=1)
